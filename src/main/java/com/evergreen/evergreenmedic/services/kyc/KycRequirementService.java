...
public class KycRequirementService {
    ...
    public KycRequirement getBasicLevelNameKycRequirement() {
        ...
        firstNameLastNameRequirement.setVerificationMethod(KycRequirementVerificationMethod.MANUAL);
    ...
    public KycRequirement getBasicLevelEmailKycRequirement() {
        ...
        emailVerificationRequirement.setVerificationMethod(KycRequirementVerificationMethod.OTP);
    ...
    public KycRequirement getBasicLevelPhoneRequirement() {
        ...
        phoneVerificationRequirement.setVerificationMethod(KycRequirementVerificationMethod.OTP);
